...
class Program
{
    static void Main(string[] args)
    {
        ...
        //Console.WriteLine(c.tipo); - Causou um erro de compilação.
        ...
        //-=-=-=-=-=
        //Explorando método com parâmetro out
        int a=10;
        int b;

        //TRECHO NÃO FUNCIONA POIS A VARIÁVEL B NÃO FOI INICIALIZADA.
        /*
        ...
        */
        ...
        Console.WriteLine("Método com número dinâmico de parâmetros");
        Console.WriteLine("  Uma lista de fato");
        int [] minhaLista = new int[4] {1,2,3,4};
        c.MetodoParam(minhaLista);

        Console.WriteLine("  Chamada com N parâmetros");
        ...
        c.PropriedadeNome="Vitória Rodrigues";
        Console.WriteLine("Nome do cliente é: "+c.PropriedadeNome);
    }
}
